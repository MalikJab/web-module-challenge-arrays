...
function addFlavor(arrayName,input){

    arrayName.unshift(input);
  return arrayName;
...
function getFlavorByIndex(arrayName, indexNum){

    console.log (arrayName[indexNum]);
